...
public class RuleBaseSystem {
	...
	public static void main(String args[]){
		...
		rules = fm.loadRules(file);
		wm = fm.loadWm(new File(new String(sb)));
...
class FileManager {
	...
	public ArrayList<Rule> loadRules(File theFile){
		ArrayList<Rule> rules = new ArrayList<Rule>();
		String line;
		try{
			int token;
			f = new FileReader(theFile);
	...
	public ArrayList<String> loadWm(File file){
